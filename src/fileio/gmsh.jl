...
"""
function load_gmsh_mesh(meshfile; element=:triangle, vertextype=Float64, order=1, physical=nothing, sort=true)
    ...
    vertices = gmsh_to_mesh_nodes(node_tags, node_coords; udim=udim, vertextype=vertextype)
